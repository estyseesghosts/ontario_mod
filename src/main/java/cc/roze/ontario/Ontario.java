...
public class Ontario implements ModInitializer {
	...
	public void onInitialize() {
		...
		Registry.register(Registries.ITEM, new Identifier("ontario", "calcite_coal_tile"), new BlockItem(CALCITE_COAL_TILE, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "calcite_bricks"), CALCITE_BRICKS);
		Registry.register(Registries.ITEM, new Identifier("ontario", "calcite_bricks"), new BlockItem(CALCITE_BRICKS, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "fake_bedrock"), FAKE_BEDROCK);
		Registry.register(Registries.ITEM, new Identifier("ontario", "fake_bedrock"), new BlockItem(FAKE_BEDROCK, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "acacia_bookshelf"), ACACIA_BOOKSHELF);
		Registry.register(Registries.ITEM, new Identifier("ontario", "acacia_bookshelf"), new BlockItem(ACACIA_BOOKSHELF, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "birch_bookshelf"), BIRCH_BOOKSHELF);
		Registry.register(Registries.ITEM, new Identifier("ontario", "birch_bookshelf"), new BlockItem(BIRCH_BOOKSHELF, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "spruce_bookshelf"), SPRUCE_BOOKSHELF);
		Registry.register(Registries.ITEM, new Identifier("ontario", "spruce_bookshelf"), new BlockItem(SPRUCE_BOOKSHELF, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "mangrove_bookshelf"), MANGROVE_BOOKSHELF);
		Registry.register(Registries.ITEM, new Identifier("ontario", "mangrove_bookshelf"), new BlockItem(MANGROVE_BOOKSHELF, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "dark_oak_bookshelf"), DARK_OAK_BOOKSHELF);
		Registry.register(Registries.ITEM, new Identifier("ontario", "dark_oak_bookshelf"), new BlockItem(DARK_OAK_BOOKSHELF, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "crimson_bookshelf"), CRIMSON_BOOKSHELF);
		Registry.register(Registries.ITEM, new Identifier("ontario", "crimson_bookshelf"), new BlockItem(CRIMSON_BOOKSHELF, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "warped_bookshelf"), WARPED_BOOKSHELF);
		Registry.register(Registries.ITEM, new Identifier("ontario", "warped_bookshelf"), new BlockItem(WARPED_BOOKSHELF, new FabricItemSettings().group(OTHER_GROUP)));
		...
		Registry.register(Registries.BLOCK, new Identifier("ontario", "andesite_bricks"), ANDESITE_BRICKS);
		Registry.register(Registries.ITEM, new Identifier("ontario", "andesite_bricks"), new BlockItem(ANDESITE_BRICKS, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "granite_bricks"), GRANITE_BRICKS);
		Registry.register(Registries.ITEM, new Identifier("ontario", "granite_bricks"), new BlockItem(GRANITE_BRICKS, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "iron_ladder"), IRON_LADDER);
		Registry.register(Registries.ITEM, new Identifier("ontario", "iron_ladder"), new BlockItem(IRON_LADDER, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "diorite_tiled_stairs"), DIORITE_TILED_STAIRS);
		Registry.register(Registries.ITEM, new Identifier("ontario", "diorite_tiled_stairs"), new BlockItem(DIORITE_TILED_STAIRS, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "diorite_tiled_slab"), DIORITE_TILED_SLAB);
		Registry.register(Registries.ITEM, new Identifier("ontario", "diorite_tiled_slab"), new BlockItem(DIORITE_TILED_SLAB, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "granite_tiled_stairs"), GRANITE_TILED_STAIRS);
		Registry.register(Registries.ITEM, new Identifier("ontario", "granite_tiled_stairs"), new BlockItem(GRANITE_TILED_STAIRS, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "granite_tiled_slab"), GRANITE_TILED_SLAB);
		Registry.register(Registries.ITEM, new Identifier("ontario", "granite_tiled_slab"), new BlockItem(GRANITE_TILED_SLAB, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "andesite_tiled_stairs"), ANDESITE_TILED_STAIRS);
		Registry.register(Registries.ITEM, new Identifier("ontario", "andesite_tiled_stairs"), new BlockItem(ANDESITE_TILED_STAIRS, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "andesite_tiled_slab"), ANDESITE_TILED_SLAB);
		Registry.register(Registries.ITEM, new Identifier("ontario", "andesite_tiled_slab"), new BlockItem(ANDESITE_TILED_SLAB, new FabricItemSettings().group(OTHER_GROUP)));

		Registry.register(Registries.BLOCK, new Identifier("ontario", "workbench"), WORKBENCH);
		Registry.register(Registries.ITEM, new Identifier("ontario", "workbench"), new BlockItem(WORKBENCH, new FabricItemSettings().group(OTHER_GROUP)));
